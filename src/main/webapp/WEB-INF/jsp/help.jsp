...
<div class="container">
    <h1>Help Section</h1>
    <p>This system allows you to manage customers, items, and bills for Pahana Edu. Use the navigation links on the home page to access different sections of the application.</p>
    <p><b>Username:</b> user<br><b>Password:</b> password</p>
